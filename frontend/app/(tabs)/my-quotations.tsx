    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={[styles.header, { marginTop: Platform.OS === 'ios' ? 30 : 20 }]}>
          ...
          <Text style={[styles.headerText, { color: colors.text }]}>Minhas Cotações</Text>
          <View style={styles.placeholder} />
        </View>

        <View style={styles.content}>
          <View style={[styles.card, { backgroundColor: colors.cardBackground, shadowColor: colors.shadowColor }]}>
            <Ionicons name="receipt" size={64} color={colors.iconMyQuotations} />
            <Text style={[styles.title, { color: colors.text }]}>
              Histórico de Cotações
            </Text>
            <Text style={[styles.description, { color: colors.textSecondary }]}>
              Visualize e acompanhe todas as suas solicitações de cotação realizadas.
            </Text>
          </View>
          ...
          <View style={[styles.infoContainer, { backgroundColor: colors.cardBackground, shadowColor: colors.shadowColor }]}>
            ...
            <View style={styles.featureItem}>
              ...
              <Text style={[styles.featureText, { color: colors.text }]}>
                Visualizar cotações pendentes
              </Text>
            </View>
            <View style={styles.featureItem}>
              <Ionicons name="checkmark-circle" size={20} color={colors.success} />
              <Text style={[styles.featureText, { color: colors.text }]}>
                Histórico de cotações finalizadas
              </Text>
            </View>
            <View style={styles.featureItem}>
              <Ionicons name="checkmark-circle" size={20} color={colors.success} />
